...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bike.last_serviced_date'
        db.add_column(u'app_bike', 'last_serviced_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bike.last_serviced_date'
        db.delete_column(u'app_bike', 'last_serviced_date')
    ...
    models = {
        u'app.bike': {
            ...
            'last_serviced_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'app.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 26, 0, 0)'}),
            ...
            'pin': ('django.db.models.fields.CharField', [], {'default': "'6529'", 'max_length': '4'}),
